...
function EditProfileClient({ chilren }) {
            ...
            <Container fluid="xxl" className={cx('wrapper')}>
                <Form>
                    ...
                    <Form.Group className={cx('row')}>
                        ...
                        <Form.Select aria-label="SEX" className={cx('output', 'Change')} onChange={(e) => onChange(e)}>
                    ...
                    <Form.Group className={cx('row')}>
                        ...
                        <Form.Label className={cx('label-title')}>{ConverTime(Profile.DateOfBirth)[2]}</Form.Label>
